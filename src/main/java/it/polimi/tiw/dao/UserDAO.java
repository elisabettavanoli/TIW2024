...
public class UserDAO {
	...
	public void createUser(String username, String name, String lastname, String email, String password) throws SQLException {
	...
	public boolean checkAuthorization(User user, int groupId) throws SQLException {
		String query = "SELECT * FROM participations WHERE user = ? AND gruppo = ?";
